...
public class Login extends javax.swing.JFrame {
    ...
    public void validar(){
        ...
        String password = txtPasswordOculto.getText();

        if(email.equals("") || password.equals("")){
            JOptionPane.showMessageDialog(this, "Debe ingresar su email y su contraseña!!!");
            txtEmail.requestFocus();
        }else{
            user=udao.ValidarUsuario(email, password); //buscó el usuario
            if(user.getEmailUser() != null && user.getPasswordUser() != null){
                MainAlmacenero main = new MainAlmacenero();
                main.setVisible(true);
                dispose();
            }else{
                JOptionPane.showMessageDialog(this, "Debe ingresar un email o contraseña válido!!!");
                txtEmail.requestFocus();
            }
        }
    }
