...
( 
	...
	RUC_RESTAURANTE      varchar(25)  NOT NULL ,
	NOMBRE_RESTAURANTE   varchar(50)  NOT NULL ,
	DESCRIPCION_RESTAURANTE varchar(150)  NULL 
)
go
...
ALTER TABLE RESTAURANTE
	ADD CONSTRAINT XPKRESTAURANTE PRIMARY KEY  CLUSTERED (ID_RESTAURANTE ASC)
go
...
ALTER TABLE SEDE
	ADD CONSTRAINT R_20 FOREIGN KEY (ID_RESTAURANTE) REFERENCES RESTAURANTE(ID_RESTAURANTE)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
go
